...
* `random fields, raw
  <https://raw.github.com/practical-neuroimaging/pna-notebooks/master/random_fields.ipynb>`_
  notebook file for downloading.
* `random fields, web
  <http://nbviewer.ipython.org/urls/raw.github.com/practical-neuroimaging/pna-notebooks/master/random_fields.ipynb>`_
  notebook presented nicely as a web page.
