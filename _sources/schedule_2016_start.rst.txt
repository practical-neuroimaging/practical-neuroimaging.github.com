###################################
Practical neuroimaging strikes back
###################################

2016 practical neuroimaging course taught as *PSYCH 214 - 001: Functional MRI
Methods*:

* class number 33732;
* 3 credits;
* Monday 13.30 |--| 16.30pm.
* first class 29 August;
* listed as *PSYCH 214* at http://guide.berkeley.edu/courses/psych.

.. Berkeley dates

    Fall semester: http://registrar.berkeley.edu/stucal.html

    Instruction begins 24 August
    Reading / review / recitation December 5-9.
...
.. Advertising
    ...
    data analysis. We will teach you how to work with data and code to get
    a deeper understanding of how fMRI methods work, how they can fail, how to
    fix them, and how to develop new methods. We will cover the basic concepts
    in neuroimaging analysis, and how they relate to the wider world of
    statistics, engineering and computer science. At the same time we will
    teach you techniques of data analysis that will make your work easier to
    organize, understand, explain and share. At the end of the course we expect
    you to be able to analyze fMRI data using Python and keep track of your
